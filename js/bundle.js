...
exports.initMentorPage = initMentorPage;

function initMentorPage() {
  return {
    showMentorPage: function showMentorPage() {
      this.$store.app.isMentorShown = true;
...
function initNavbar() {
  return {
    ...
    showMentorPage: function showMentorPage() {
      this.$store.app.isMentorPageShown = true;
      (0, _pageloader.showPageLoader)();
      setTimeout(function () {
        document.getElementById("home-page").style.display = "none";
        document.getElementById("home-page-details").style.display = "none";
        document.getElementById("mentor-page").style.display = "";
        document.getElementById("candidate-nav").classList.remove("is-active");
        document.getElementById("mentor-nav").classList.add("is-active");
        document.getElementById("candidate-nav-clone").classList.remove("is-active");
        document.getElementById("mentor-nav-clone").classList.add("is-active");
      }, 1000);
    },
    showHomePage: function showHomePage() {
      this.$store.app.isMentorPageShown = false;
      (0, _pageloader.showPageLoader)();
      setTimeout(function () {
        document.getElementById("mentor-page").style.display = "none";
        document.getElementById("home-page").style.display = "";
        document.getElementById("home-page-details").style.display = "";
        document.getElementById("candidate-nav").classList.add("is-active");
        document.getElementById("mentor-nav").classList.remove("is-active");
        document.getElementById("candidate-nav-clone").classList.add("is-active");
        document.getElementById("mentor-nav-clone").classList.remove("is-active");
      }, 1000);
    }
  };
}

},{"./pageloader":7}],7:[function(require,module,exports){
"use strict";
...
var _mentor = require("./libs/components/mentor");
...
window.initMentorPage = _mentor.initMentorPage;
...
},{"./libs/components/backtotop":4,"./libs/components/mentor":5,"./libs/components/navbar":6,"./libs/components/pageloader":7,"./libs/components/sidebar":8,"./libs/utils/constants":9,"./libs/utils/utils":10,"./store/store":12,"alpinejs":2,"feather-icons":3}],12:[function(require,module,exports){
"use strict";
...
Spruce.store('app', {
  ...
  isMentorPageShown: false,
  isHomePageShown: true
}, true);
var _default = Spruce;
exports["default"] = _default;

},{"@ryangjchandler/spruce":1}]},{},[11]);
